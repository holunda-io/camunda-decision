...
import io.holunda.decision.model.converter.HitPolicyConverter
import io.holunda.decision.model.converter.HitPolicyConverter.HitPolicyPair
import io.holunda.decision.model.converter.HitPolicyConverter.convert
...
internal class HitPolicyConverterTest {
  ...
  fun `to dmnHitPolicy`() {
    ...
    assertThat(convert(HitPolicy.PRIORITY, null)).isEqualTo(DmnHitPolicy.PRIORITY)
    ...
    assertThat(convert(HitPolicy.OUTPUT_ORDER, null)).isEqualTo(DmnHitPolicy.OUTPUT_ORDER)
  ...
  fun `from dmnHitPolicy`() {
    ...
    assertThat(convert(DmnHitPolicy.PRIORITY)).isEqualTo(HitPolicyPair(HitPolicy.PRIORITY, null))
    ...
    assertThat(convert(DmnHitPolicy.OUTPUT_ORDER)).isEqualTo(HitPolicyPair(HitPolicy.OUTPUT_ORDER, null))
